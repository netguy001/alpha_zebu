    ...
    return (
        <div className="min-h-screen flex items-center justify-center" style={{ background: '#07080f' }}>
            <div className="text-center space-y-4">
                {status === 'processing' && (
                    <>
                        <div className="w-12 h-12 mx-auto border-2 border-emerald-500 border-t-transparent rounded-full animate-spin" />
                        <p className="text-gray-400 text-sm">Connecting your broker account...</p>
                    </>
                )}
                {status === 'success' && (
                    <>
                        ...
                        <p className="text-white text-sm font-medium">Broker connected!</p>
